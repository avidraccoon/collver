...
define void @proc_draw_background() {
  call void @push(i64 0)
  call void @push(i64 0)
...
ls18:                                             ; preds = %l18
  call void @push(i64 1)
  %ptrto_running_3 = ptrtoint ptr %mem_running to i64
  call void @push(i64 %ptrto_running_3)
  call void @proc_intrinsic_store64()
  br label %l22
...
l25:                                              ; preds = %l22
  ...
  %a7 = call i64 @pop()
  %b7 = icmp ne i64 %a7, 0
  br i1 %b7, label %l30, label %l34

l30:                                              ; preds = %l25
  call void @push(i64 0)
  %ptrto_running_8 = ptrtoint ptr %mem_running to i64
  call void @push(i64 %ptrto_running_8)
  call void @proc_intrinsic_store64()
  br label %l34
...
ls34:                                             ; preds = %l34
  %ptrto_handle_9 = ptrtoint ptr %mem_handle to i64
  call void @push(i64 %ptrto_handle_9)
  call void @proc_intrinsic_load64()
  call void @proc_draw_background()
  %ptrto_handle_10 = ptrtoint ptr %mem_handle to i64
  call void @push(i64 %ptrto_handle_10)
  call void @proc_intrinsic_load64()
