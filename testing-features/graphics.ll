...
@str_main_15 = private unnamed_addr constant [23 x i8] c"Collver graphics demo\0A\00"
@str_main_23 = private unnamed_addr constant [41 x i8] c"Drawing a horizontal gradient-ish line:\0A\00"
@str_main_58 = private unnamed_addr constant [2 x i8] c"#\00"
@str_main_69 = private unnamed_addr constant [7 x i8] c"Done.\0A\00"
...
define void @proc_main() {
  ...
  %strptr23 = ptrtoint ptr @str_main_23 to i64
  %strptr58 = ptrtoint ptr @str_main_58 to i64
  %strptr69 = ptrtoint ptr @str_main_69 to i64
  %mem_i = alloca [8 x i8], align 1
  call void @proc_intrinsic_drop()
  call void @proc_intrinsic_drop()
  call void @proc_gfx_hide_cursor()
  call void @proc_intrinsic_drop()
  call void @proc_gfx_clear()
  call void @proc_intrinsic_drop()
  call void @push(i64 4)
  call void @push(i64 2)
  call void @proc_gfx_move_to()
  call void @proc_intrinsic_drop()
...
ls62:                                             ; preds = %l62
  ...
  call void @proc_gfx_move_to()
  call void @proc_intrinsic_drop()
  call void @push(i64 %strptr69)
  call void @proc_puts()
  call void @proc_gfx_show_cursor()
  call void @proc_intrinsic_drop()
  call void @proc_gfx_reset_style()
  call void @proc_intrinsic_drop()
  call void @push(i64 0)
