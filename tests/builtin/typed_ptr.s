...
.Lfunc_end44:
	...
	.cfi_endproc
                                        # -- End function
	.globl	proc_use_typed_ptr              # -- Begin function proc_use_typed_ptr
	.p2align	4, 0x90
	.type	proc_use_typed_ptr,@function
proc_use_typed_ptr:                     # @proc_use_typed_ptr
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end45:
	.size	proc_use_typed_ptr, .Lfunc_end45-proc_use_typed_ptr
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	movl	$123, %edi
	callq	push@PLT
	callq	proc_ptrto@PLT
	callq	proc_use_typed_ptr@PLT
	popq	%rax
	.cfi_def_cfa_offset 8
	retq
.Lfunc_end46:
