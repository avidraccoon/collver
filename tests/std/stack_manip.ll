...
@str_main_8 = private unnamed_addr constant [7 x i8] c"under\0A\00"
@str_main_9 = private unnamed_addr constant [6 x i8] c"over\0A\00"
define void @proc_main() {
  %strptr8 = ptrtoint ptr @str_main_8 to i64
  ...
  ; <OT.PROC_CALL on print>
  call void() @proc_print()
  ; <OT.PUSH_STR on under\0A>
  call void(i64) @push(i64 %strptr8)
  ; <OT.PUSH_STR on over\0A>
  call void(i64) @push(i64 %strptr9)
  ; <OT.PROC_CALL on over>
  call void() @proc_over()
  ; <OT.PROC_CALL on puts>
  call void() @proc_puts()
