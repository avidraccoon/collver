...
@str_vec_add_first_12 = private unnamed_addr constant [59 x i8] c"error: vec_add_first called with non-null `start` pointer\0A\00"
@str_vec_add_first_15 = private unnamed_addr constant [30 x i8] c"  note: `start` pointer was: \00"
@str_vec_add_first_23 = private unnamed_addr constant [67 x i8] c"  note: if you weren't expecting this, report the issue on github\0A\00"
@str_vec_add_first_26 = private unnamed_addr constant [15 x i8] c"  aborting :(\0A\00"
@str_vec_dbg_2 = private unnamed_addr constant [13 x i8] c"vec.count : \00"
@str_vec_dbg_9 = private unnamed_addr constant [13 x i8] c"vec.cap   : \00"
@str_vec_dbg_16 = private unnamed_addr constant [13 x i8] c"vec.size  : \00"
@str_vec_dbg_23 = private unnamed_addr constant [13 x i8] c"vec.start : \00"
@str_vec_print_int_2 = private unnamed_addr constant [2 x i8] c"[\00"
@str_vec_print_int_33 = private unnamed_addr constant [3 x i8] c", \00"
@str_vec_print_int_40 = private unnamed_addr constant [3 x i8] c"]\0A\00"
@str_vec_print_str_5 = private unnamed_addr constant [2 x i8] c"[\00"
@str_vec_print_str_46 = private unnamed_addr constant [3 x i8] c", \00"
@str_vec_print_str_53 = private unnamed_addr constant [3 x i8] c"]\0A\00"
@str_arg_to_str_0 = private unnamed_addr constant [1 x i8] zeroinitializer
@str_arg_to_str_24 = private unnamed_addr constant [2 x i8] c" \00"
@str_main_2 = private unnamed_addr constant [20 x i8] c"python3 collver.py \00"
...
define void @proc_vec_init() {
  %mem_size = alloca [8 x i8], align 1
  %mem_vec_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
  %ptrto_size_1 = ptrtoint ptr %mem_size to i64
  call void @push(i64 %ptrto_size_1)
  call void @proc_intrinsic_store64()
  call void @push(i64 0)
  %ptrto_vec_ptr_2 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_2)
  call void @proc_intrinsic_loadptr()
  call void @push(i64 0)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  call void @push(i64 0)
  %ptrto_vec_ptr_3 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_3)
  call void @proc_intrinsic_loadptr()
  call void @push(i64 8)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  ...
  call void @push(i64 %ptrto_size_4)
  call void @proc_intrinsic_load64()
  %ptrto_vec_ptr_5 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_5)
  call void @proc_intrinsic_loadptr()
  call void @push(i64 16)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  call void @push(i64 0)
  %ptrto_vec_ptr_6 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_6)
  call void @proc_intrinsic_loadptr()
...
define void @proc_vec_new() {
  ...
  call void @proc_intrinsic_alloc()
  %ptrto_vec_ptr_1 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_1)
  call void @proc_intrinsic_storeptr()
  %ptrto_size_2 = ptrtoint ptr %mem_size to i64
  call void @push(i64 %ptrto_size_2)
  call void @proc_intrinsic_load64()
  ...
  call void @push(i64 %ptrto_vec_ptr_3)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_init()
  %ptrto_vec_ptr_4 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_4)
  call void @proc_intrinsic_loadptr()
  ret void
}

define void @proc_vec_read_count() {
  call void @push(i64 0)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_load64()
  ret void
...
define void @proc_vec_write_count() {
  call void @push(i64 0)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  ret void
...
define void @proc_vec_write_cap() {
  call void @push(i64 8)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  ret void
...
define void @proc_vec_read_size() {
  call void @push(i64 16)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_load64()
  ret void
...
define void @proc_vec_write_size() {
  call void @push(i64 16)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_store64()
  ret void
...
define void @proc_vec_read_start() {
  call void @push(i64 24)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_loadptr()
  ret void
...
define void @proc_vec_write_start() {
  call void @push(i64 24)
  call void @proc_intrinsic_plus()
  call void @proc_intrinsic_storeptr()
  ret void
...
define void @proc_vec_add_first() {
  %strptr12 = ptrtoint ptr @str_vec_add_first_12 to i64
  %strptr15 = ptrtoint ptr @str_vec_add_first_15 to i64
  %strptr23 = ptrtoint ptr @str_vec_add_first_23 to i64
  %strptr26 = ptrtoint ptr @str_vec_add_first_26 to i64
  %mem_item_ptr = alloca [8 x i8], align 1
  %mem_vec_ptr = alloca [8 x i8], align 1
  %mem_start_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
  %ptrto_item_ptr_1 = ptrtoint ptr %mem_item_ptr to i64
  call void @push(i64 %ptrto_item_ptr_1)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec_ptr_2 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_2)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  call void @proc_cast_ptr_to_int()
  call void @push(i64 0)
  call void @proc_intrinsic_ne()
  %a3 = call i64 @pop()
  %b3 = icmp ne i64 %a3, 0
  br i1 %b3, label %l11, label %l31

l11:                                              ; preds = %0
  call void @push(i64 %strptr12)
  call void @proc_cast_str_to_ptr()
  call void @proc_puts()
...
ls31:                                             ; preds = %l31
  ...
  call void @push(i64 %ptrto_vec_ptr_5)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  call void @proc_intrinsic_alloc()
  %ptrto_start_ptr_6 = ptrtoint ptr %mem_start_ptr to i64
  call void @push(i64 %ptrto_start_ptr_6)
  call void @proc_intrinsic_storeptr()
  %ptrto_start_ptr_7 = ptrtoint ptr %mem_start_ptr to i64
  call void @push(i64 %ptrto_start_ptr_7)
  call void @proc_intrinsic_loadptr()
  %ptrto_vec_ptr_8 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_8)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_start()
  %ptrto_vec_ptr_9 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_9)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  %ptrto_item_ptr_10 = ptrtoint ptr %mem_item_ptr to i64
  call void @push(i64 %ptrto_item_ptr_10)
  call void @proc_intrinsic_loadptr()
  %ptrto_start_ptr_11 = ptrtoint ptr %mem_start_ptr to i64
  call void @push(i64 %ptrto_start_ptr_11)
  call void @proc_intrinsic_loadptr()
  call void @proc_memcpy()
  call void @push(i64 1)
  %ptrto_vec_ptr_12 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_12)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_count()
  call void @push(i64 1)
  %ptrto_vec_ptr_13 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_13)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_cap()
  ret void
}

define void @proc_vec_update_cap() {
  %mem_vec_ptr = alloca [8 x i8], align 1
  %mem_new_start_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
  br label %l2
...
l2:                                               ; preds = %l10, %0
  ...
  call void @push(i64 %ptrto_vec_ptr_1)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_cap()
  %ptrto_vec_ptr_2 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_2)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  call void @proc_intrinsic_le()
  %a3 = call i64 @pop()
  %b3 = icmp ne i64 %a3, 0
  br i1 %b3, label %l10, label %l53
...
l10:                                              ; preds = %l2
  ...
  call void @proc_intrinsic_mult()
  call void @proc_intrinsic_alloc()
  %ptrto_new_start_ptr_6 = ptrtoint ptr %mem_new_start_ptr to i64
  call void @push(i64 %ptrto_new_start_ptr_6)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec_ptr_7 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_7)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  %ptrto_vec_ptr_8 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_8)
  ...
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  %ptrto_new_start_ptr_10 = ptrtoint ptr %mem_new_start_ptr to i64
  call void @push(i64 %ptrto_new_start_ptr_10)
  call void @proc_intrinsic_loadptr()
  call void @proc_memcpy()
  %ptrto_vec_ptr_11 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_11)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  call void @proc_intrinsic_free()
  %ptrto_new_start_ptr_12 = ptrtoint ptr %mem_new_start_ptr to i64
  call void @push(i64 %ptrto_new_start_ptr_12)
  call void @proc_intrinsic_loadptr()
  %ptrto_vec_ptr_13 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_13)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_start()
  %ptrto_vec_ptr_14 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_14)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_cap()
  call void @push(i64 2)
  call void @proc_intrinsic_mult()
  %ptrto_vec_ptr_15 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_15)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_cap()
  br label %l2
...
define void @proc_vec_push() {
  ...
  %a3 = call i64 @pop()
  %b3 = icmp ne i64 %a3, 0
  br i1 %b3, label %l10, label %l16

l10:                                              ; preds = %0
  %ptrto_item_ptr_4 = ptrtoint ptr %mem_item_ptr to i64
  call void @push(i64 %ptrto_item_ptr_4)
  call void @proc_intrinsic_loadptr()
  %ptrto_vec_ptr_5 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_5)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_add_first()
  br label %l42
...
l16:                                              ; preds = %0
  ...
  call void @push(i64 %ptrto_vec_ptr_6)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_update_cap()
  %ptrto_vec_ptr_7 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_7)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  %ptrto_item_ptr_8 = ptrtoint ptr %mem_item_ptr to i64
  call void @push(i64 %ptrto_item_ptr_8)
  call void @proc_intrinsic_loadptr()
  %ptrto_vec_ptr_9 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_9)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  %ptrto_vec_ptr_10 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_10)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  call void @proc_intrinsic_mult()
  %ptrto_vec_ptr_11 = ptrtoint ptr %mem_vec_ptr to i64
...
define void @proc_vec_elemcpy() {
  %mem_idx = alloca [8 x i8], align 1
  %mem_vec_ptr = alloca [8 x i8], align 1
  %mem_cpy_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
  %ptrto_idx_1 = ptrtoint ptr %mem_idx to i64
  ...
  call void @proc_vec_read_size()
  call void @proc_intrinsic_alloc()
  %ptrto_cpy_ptr_3 = ptrtoint ptr %mem_cpy_ptr to i64
  call void @push(i64 %ptrto_cpy_ptr_3)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec_ptr_4 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_4)
  call void @proc_intrinsic_loadptr()
  ...
  call void @push(i64 %ptrto_vec_ptr_6)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_elem()
  %ptrto_cpy_ptr_7 = ptrtoint ptr %mem_cpy_ptr to i64
  call void @push(i64 %ptrto_cpy_ptr_7)
  call void @proc_intrinsic_loadptr()
  call void @proc_memcpy()
  %ptrto_cpy_ptr_8 = ptrtoint ptr %mem_cpy_ptr to i64
  call void @push(i64 %ptrto_cpy_ptr_8)
  call void @proc_intrinsic_loadptr()
  ret void
}

define void @proc_vec_pop() {
  %mem_vec_ptr = alloca [8 x i8], align 1
  %mem_cpy_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  ...
  %ptrto_cpy_ptr_5 = ptrtoint ptr %mem_cpy_ptr to i64
  call void @push(i64 %ptrto_cpy_ptr_5)
  call void @proc_intrinsic_loadptr()
  ret void
}

define void @proc_vec_extend() {
  %mem_vec1 = alloca [8 x i8], align 1
  %mem_vec2 = alloca [8 x i8], align 1
  %ptrto_vec2_0 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_0)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec1_1 = ptrtoint ptr %mem_vec1 to i64
  call void @push(i64 %ptrto_vec1_1)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec1_2 = ptrtoint ptr %mem_vec1 to i64
  call void @push(i64 %ptrto_vec1_2)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  %ptrto_vec2_3 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_3)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  call void @proc_intrinsic_plus()
  %ptrto_vec1_4 = ptrtoint ptr %mem_vec1 to i64
  call void @push(i64 %ptrto_vec1_4)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_count()
  %ptrto_vec1_5 = ptrtoint ptr %mem_vec1 to i64
  call void @push(i64 %ptrto_vec1_5)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_update_cap()
  %ptrto_vec2_6 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_6)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  %ptrto_vec2_7 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_7)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  call void @proc_intrinsic_mult()
  %ptrto_vec2_8 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_8)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  %ptrto_vec1_9 = ptrtoint ptr %mem_vec1 to i64
  call void @push(i64 %ptrto_vec1_9)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  %ptrto_vec2_10 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_10)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_size()
  %ptrto_vec2_11 = ptrtoint ptr %mem_vec2 to i64
  call void @push(i64 %ptrto_vec2_11)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_count()
  call void @proc_intrinsic_mult()
  call void @proc_intrinsic_plus()
...
define void @proc_vec_free() {
  %mem_vec = alloca [8 x i8], align 1
  %ptrto_vec_0 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_0)
  call void @proc_intrinsic_storeptr()
  %ptrto_vec_1 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_1)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  call void @proc_cast_ptr_to_int()
  call void @push(i64 0)
  ...
  %a2 = call i64 @pop()
  %b2 = icmp ne i64 %a2, 0
  br i1 %b2, label %l9, label %l19

l9:                                               ; preds = %0
  %ptrto_vec_3 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_3)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_read_start()
  call void @proc_intrinsic_free()
  call void @push(i64 0)
  call void @proc_cast_int_to_ptr()
  %ptrto_vec_4 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_4)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_write_start()
  br label %l19
...
define void @proc_vec_free_dynamic() {
  %mem_vec = alloca [8 x i8], align 1
  %ptrto_vec_0 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_0)
  call void @proc_intrinsic_storeptr()
  ...
  call void @push(i64 %ptrto_vec_1)
  call void @proc_intrinsic_loadptr()
  call void @proc_vec_free()
  %ptrto_vec_2 = ptrtoint ptr %mem_vec to i64
  call void @push(i64 %ptrto_vec_2)
  call void @proc_intrinsic_loadptr()
  call void @proc_intrinsic_free()
  ret void
}

define void @proc_vec_dbg() {
  %strptr2 = ptrtoint ptr @str_vec_dbg_2 to i64
  %strptr9 = ptrtoint ptr @str_vec_dbg_9 to i64
  %strptr16 = ptrtoint ptr @str_vec_dbg_16 to i64
  %strptr23 = ptrtoint ptr @str_vec_dbg_23 to i64
  %mem_vec_ptr = alloca [8 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
...
define void @proc_vec_print_int() {
  %strptr2 = ptrtoint ptr @str_vec_print_int_2 to i64
  %strptr33 = ptrtoint ptr @str_vec_print_int_33 to i64
  %strptr40 = ptrtoint ptr @str_vec_print_int_40 to i64
  %mem_vec_ptr = alloca [8 x i8], align 1
...
define void @proc_vec_print_str() {
  %strptr5 = ptrtoint ptr @str_vec_print_str_5 to i64
  %strptr46 = ptrtoint ptr @str_vec_print_str_46 to i64
  %strptr53 = ptrtoint ptr @str_vec_print_str_53 to i64
  %mem_vec_ptr = alloca [8 x i8], align 1
  %mem_i = alloca [8 x i8], align 1
  %mem_dquote = alloca [1 x i8], align 1
  %ptrto_vec_ptr_0 = ptrtoint ptr %mem_vec_ptr to i64
  call void @push(i64 %ptrto_vec_ptr_0)
  call void @proc_intrinsic_storeptr()
  call void @push(i64 34)
  %ptrto_dquote_1 = ptrtoint ptr %mem_dquote to i64
  call void @push(i64 %ptrto_dquote_1)
  call void @proc_intrinsic_store8()
...
l11:                                              ; preds = %ls49, %0
  ...
  %a5 = call i64 @pop()
  %b5 = icmp ne i64 %a5, 0
  br i1 %b5, label %l18, label %l52

l18:                                              ; preds = %l11
  call void @push(i64 1)
  %ptrto_dquote_6 = ptrtoint ptr %mem_dquote to i64
  call void @push(i64 %ptrto_dquote_6)
  call void @push(i64 1)
  call void @proc_sys_write()
  call void @proc_intrinsic_drop()
  %ptrto_i_7 = ptrtoint ptr %mem_i to i64
  ...
  call void @proc_puts()
  call void @push(i64 1)
  %ptrto_dquote_9 = ptrtoint ptr %mem_dquote to i64
  call void @push(i64 %ptrto_dquote_9)
  call void @push(i64 1)
  call void @proc_sys_write()
  call void @proc_intrinsic_drop()
  %ptrto_i_10 = ptrtoint ptr %mem_i to i64
...
define void @proc_arg_to_str() {
  ...
  %strptr24 = ptrtoint ptr @str_arg_to_str_24 to i64
...
l11:                                              ; preds = %l15, %0
  ...
  %a3 = call i64 @pop()
  %b3 = icmp ne i64 %a3, 0
  br i1 %b3, label %l15, label %l33

l15:                                              ; preds = %l11
  %ptrto_args_4 = ptrtoint ptr %mem_args to i64
  call void @push(i64 %ptrto_args_4)
  call void @proc_intrinsic_loadptr()
  call void @proc_cast_ptr_to_str()
  %ptrto_cur_pointer_5 = ptrtoint ptr %mem_cur_pointer to i64
  call void @push(i64 %ptrto_cur_pointer_5)
  call void @proc_intrinsic_loadptr()
  call void @proc_intrinsic_loadptr()
  call void @proc_cast_ptr_to_str()
  call void @proc_strconcat()
  ...
  call void @proc_strconcat()
  call void @proc_cast_str_to_ptr()
  %ptrto_args_6 = ptrtoint ptr %mem_args to i64
  call void @push(i64 %ptrto_args_6)
  call void @proc_intrinsic_storeptr()
  %ptrto_cur_pointer_7 = ptrtoint ptr %mem_cur_pointer to i64
  call void @push(i64 %ptrto_cur_pointer_7)
  call void @proc_inc64()
  call void @push(i64 1)
  call void @proc_intrinsic_minus()
  br label %l11
...
ls33:                                             ; preds = %l33
  call void @proc_intrinsic_drop()
  %ptrto_args_8 = ptrtoint ptr %mem_args to i64
  call void @push(i64 %ptrto_args_8)
  call void @proc_intrinsic_loadptr()
  call void @proc_cast_ptr_to_str()
  ret void
}

define void @proc_fix_args() {
  call void @proc_cast_ptr_to_int()
  call void @proc_swap()
  call void @proc_cast_int_to_ptr()
  ret void
